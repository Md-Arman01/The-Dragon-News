    ...
    <div className="flex justify-center items-center mt-28">
      <div className="relative flex w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
        ...
        <div className="p-6 pt-0">
          <button
            className="normal-case block w-full select-none rounded-lg bg-gradient-to-tr from-[#403F3F] to-[#403F3F] py-3 px-6 text-center align-middle font-sans text-xs font-bold  text-white shadow-md shadow-[#403F3F]/20 transition-all hover:shadow-lg hover:shadow-[#403F3F]/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
            type="submit"
          ...
          <p className="mt-6 flex justify-center font-sans text-sm font-light leading-normal text-inherit antialiased">
            ...
            <Link
              to="/resister"
              href="#signup"
              className="ml-1 block font-sans text-sm font-bold leading-normal text-[#403F3F] antialiased">
              Register
            </Link>
          </p>
        </div>
