    ...
    <>
      ...
      <div>
        ...
        <div className="flex flex-col my-4">
          <button className="btn bg-white rounded-t-md rounded-none normal-case text-sm text-[#706F6F] font-medium">
            <svg
          ...
          <button className="btn bg-white rounded-none normal-case text-sm text-[#706F6F] font-medium">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="30"
              height="30"
          ...
          <button className="btn bg-white rounded-b-md rounded-none normal-case text-sm text-[#706F6F] font-medium">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="30"
              height="30"
      ...
      <h1 className="text-xl font-bold">Q-Zone</h1>
        ...
        <div className="flex flex-col px-8 space-y-2 my-5">
        <img src="https://i.ibb.co/F8Ygx0m/qZone1.png" alt="" />
        <img src="https://i.ibb.co/D9W68Yy/qZone2.png" alt="" />
        <img src="https://i.ibb.co/HxPbBDj/qZone3.png" alt="" />
        </div>
      </div>
    </>
  );
